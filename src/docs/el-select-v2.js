const attributes = [
  ...
  {
    name: 'options',
    description: '选项的数据源， value 的 key 和 label 可以通过 props自定义',
    type: 'array',
    value: '—',
    default: '—'
  },
  {
    name: 'props',
    description: '配置选项：object:{value,label,options,disabled}',
    type: 'object',
    value: '—',
    default: '—'
  },
  ...
  {
    name: 'height',
    description: '下拉菜单的高度，每一个选项为34px',
    type: 'number',
    value: '-',
    default: '274'
  },
